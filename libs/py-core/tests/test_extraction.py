...
from py_core.exceptions import ExtractionError
from py_core.extraction import (
    _get_client,
...
class TestCreateInstructorClient:
    ...
    @patch("py_core.extraction.OpenAI")
    @patch("py_core.extraction.instructor.from_openai")
...
class TestExtract:
    ...
    @patch("py_core.extraction._get_client")
...
class TestLazyInit:
    ...
    @patch("py_core.extraction._client", None)
    @patch("py_core.extraction.create_instructor_client")
    ...
    @patch("py_core.extraction._client", MagicMock())
    @patch("py_core.extraction.create_instructor_client")
